...
const render_product_page = async (req, res) => {
    ...
    try {
        ...
        res.render('admin/product', { Admin: admin, products:products, success: req.flash('success')[0], error: req.flash('false')[0] });
    } catch (error) {
...
const render_new_product = async (req, res) => {
    ...
    res.render('admin/new-product', { fullscreen: true, Admin: admin, category: category })
}
